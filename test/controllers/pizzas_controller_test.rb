...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { ingredients: @pizza.ingredients, name: @pizza.name, price: @pizza.price } }, as: :json
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { ingredients: @pizza.ingredients, name: @pizza.name, price: @pizza.price } }, as: :json
    assert_response 200
  end
